              ...
              <Box flexDirection="row" display="flex" alignItems="center">
                ...
                <Grid container>
                  ...
                  <Grid item xl={6} lg={6} md={6} sm={6} xs={6}>
                    ...
                    <div className={classes.seperator1} />
                    <Typography>Steel Structure</Typography>
                    <div className={classes.seperator1} />
                  </Grid>
                </Grid>
                <Divider />
                ...
                {_.map(images, (image) => {
                  return (
                    <Image
                      aspectRatio={16 / 9}
                      src={
                        "https://h7f7z2r7.stackpathcdn.com/sites/default/files/images/articles/blakcstonemain.jpg"
                      }
                    />
                  );
                })}
...
export default WareHouseDetailsUI;
