                ...
                <Grid container>
                  ...
                  <Grid item lg={4} xs={4} sm={4} md={4} xl={4}>
                    ...
                    >
                      {Math.floor(
                        propertyDetails &&
                          propertyDetails.propertyGroup.installment / 31536000
                      )}{" "}
                      {t("year")}
                      {Math.floor(
                        propertyDetails &&
                ...
                <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
                  <Box align="left">
                    ...
                    <Box className={classes.detailTextContainer}>
                      ...
                      <Typography>
                        ${propertyDetails && propertyDetails.unitPrice}{" "}
                        {t("per")} m<sup style={{ fontSize: 13 }}>2</sup>
                      </Typography>
                    </Box>
